...
export class MultiSeriesComponent implements OnInit {
    ...
    private drawAxis(): void {
        ...
        this.g.append('g')
            ...
            this.svg.append("g").attr("width", 40).attr("height", 50).append("circle").attr("cx", 930).attr("cy", 10).attr("r", 8).style("fill", "green");
            this.svg.append("g").attr("width", 40).attr("height", 50).append("circle").attr("cx", 930).attr("cy", 30).attr("r", 8).style("fill", "blue");
            this.svg.append("g").attr("width", 40).attr("height", 50).append("circle").attr("cx", 930).attr("cy", 50).attr("r", 8).style("fill", "orange");
    }
